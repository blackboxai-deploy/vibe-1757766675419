  ...
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable}`}>
      ...
      <body className={`${inter.className} bg-black text-white antialiased`}>
        ...
        {/* Sticky Action Bar */}
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-sm border-t border-gold/20 p-4 md:hidden">
          <div className="flex gap-3 max-w-sm mx-auto">
            <a
              href="tel:+97143591532"
              className="flex-1 bg-gold/90 hover:bg-gold text-black font-semibold py-3 px-4 rounded-lg text-center transition-colors"
            >
              Call Now
            </a>
            <a
              href="#book"
              className="flex-1 border border-gold text-gold hover:bg-gold/10 font-semibold py-3 px-4 rounded-lg text-center transition-colors"
            >
              Book Now
            </a>
          </div>
